<template>
  <div class="flex-1 flex"  v-if="tweet">
    <div class="flex-1 border-r border-gray-100">
        <div class="flex flex-col">
            ...
            <div class="h-px w-full bg-gray-100"></div>
            <!-- comments -->
            <div v-for="comment in comments" :key="comment" class="flex hover:bg-gray-100 cursor-pointer py-3 px-3 border-b border-gray-100">
                <img :src="comment.profile_image_url" class="w-10 h-10 rounded-full hover:opacity-90 cursor-pointer mr-3">
    ...
    <trends></trends>
    <comment-modal :tweet="tweet" v-if="showCommentModal" @closeModal="showCommentModal = false"></comment-modal>
  </div>
</template>
